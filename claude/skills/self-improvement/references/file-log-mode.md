...
**Note:** the `scripts/`, `assets/`, and sibling reference files this document mentions below were archived with the original skill at `~/.claude/skills/_archived-2026-08-14/self-improving-agent/` — copy what you need from there to enable the hook automation described here.
